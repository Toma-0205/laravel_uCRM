...
const storeCustomer = () => {
    console.log('storeCustomer called'); // デバッグ用ログ
    console.log('Form Data:', form); // フォームデータの内容を確認
